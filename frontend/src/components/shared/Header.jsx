...
export default function Header() {
	...
	return (
		<div className="bg-blue-950 h-16 fixed px-4 flex items-center border-b border-gray-200 justify-between w-full">
						...
						<>
							<Popover.Button
								className={classNames(
									open && 'bg-indigo-600 ',
									'group inline-flex items-center rounded-sm p-1.5 text-white hover:text-opacity-100 focus:outline-none active:bg-indigo-600 '
								)}
							>
